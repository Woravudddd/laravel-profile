    ...
    <div class="row">
        <div class="col-xl-4 col-md-3 col-sm-2">
            ...
            <div class="card mb-4 mb-xl-0">
                ...
                <form action="{{ route('uploadImagePage',$profilecard->id  ) }} " enctype="multipart/form-data"  method="POST">
                @csrf
                <div class="card-header">Profile Picture</div>
                <div class="card-body text-center">
                <img class="img-account-profile rounded-circle mb-2" src="/images/{{$profilecard->image}}" alt="" width="150" height="100" ><br>
